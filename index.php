        ...
        <div class="row position-relative justify-content-center">
          <div class="col-xxl-6 col-xl-7 col-lg-8 col-md-11 order-lg-1 order-1" data-aos="fade-right" data-aos-duration="800" data-aos-once="true">
            <div class="content text-center">
              <h1>Manage Complaint and Paperwork, One Place!</h1>
              <p>Create a complaint with privacy and submit a paperwork under 10 minutes</p>
              <a href="view/login.php" class="btn">Let's get started</a>
            </div>
          </div>
          <div class="col-xl-8 col-lg-9 order-lg-1 order-0">
            <div class="hero-area-image">
              <img src="image/ui.jpg" alt="" class="w-100">
            </div>
          </div>
        </div>
      </div>
